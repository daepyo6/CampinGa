...
public class BusinessmanCampingListUpdateAction implements Action {
	...
	String url = "camp.do?command=businessmanCampingListInsert";
	...
	if ( bvo == null ) {
		...
		bmvo.setCaddress1(request.getParameter("caddress2"));
		bmvo.setCaddress1(request.getParameter("caddress3"));
