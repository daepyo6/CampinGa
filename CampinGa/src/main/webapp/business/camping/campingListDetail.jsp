...
<article>
	<form action="camp.do" method="post" enctype="multipart/form-data">
		<fieldset>
			<div> <br><br><br><br>
				<div>
					<label>캠핑장 이름 : ${campingVO.cname}</label>
					 <input type="text" name="cname" size="20">
				</div>
				<div class="inputDiv">
					<label>캠핑장 주소 : </label> <select name="caddress1">
						<!-- 나중에 forEach로 바꾸기 -->
						<option value="0">도/시 선택</option>
						<option value="1">서울시</option>
						<option value="2">경기도</option>
					</select> <select name="caddress2">
						<!-- 나중에 forEach로 바꾸기 -->
				...
				<div class="buttons">
					<input type="button" value="등록하기"
						onclick="location.href='camp.do?command=businessmanCampingListInsert'">
					<input type="button" value="취소"
						onclick="location.href='camp.do?command=index'">
				</div>
			</div>
